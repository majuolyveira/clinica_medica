...
<html lang="en">
    <head>
        ...
        <title>Clínica Odontológica | Ver Consultas</title>
    ...
    <body>
        ...
        <main role="main" class="container">
            <div class="jumbotron">
                <h1 class="text-center">Ver Consultas</h1>
                <center>
                    <img src="../img/visualizar_consulta.png" width="150px">
                </center>
                <hr>
                <table class="table table-striped"> 
                    ...
                    <?php
                        ...
                        $sql = mysql_query("SELECT * FROM consulta");
