...
<html lang="en">
    <head>
        ...
        <title>Clínica Odontológica | Login do Odontólogo</title>
        <link href="../css/bootstrap.min.css" rel="stylesheet">
        <link href="../css/login.css" rel="stylesheet">
    </head>
    <body class="text-center">
        <form class="form-signin" action="recebe_login_medico.php" method="post">
            <img class="mb-4" src="../img/login_odontologo.png" alt="" width="200" height="200">
            <h1 class="h3 mb-3 font-weight-normal">Odontólogo</h1>
